#
#  Be sure to run `pod spec lint NKRecorder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Nurishka"
  # s.authors            = { "Nurishka" => "nurim98@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Nurishka"
  ...
  # s.resource  = "icon.png"
  s.resources = "NKRecorder/**/*.{storyboard,pdf,png,jpeg,jpg,ttf,xcassets}"
